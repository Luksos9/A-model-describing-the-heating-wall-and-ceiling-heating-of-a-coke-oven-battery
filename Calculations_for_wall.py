...
""" To determine """
# Time after 1200 K will be reached at the surface of a 2 layer wall
...
final = calc_t(Fo, L, a)
print("1200 K will be reached after: {} h".format(final / 3600))
